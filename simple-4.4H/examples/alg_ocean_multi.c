...
/* others do a black				                     */
   ...
   evenistart = gp_ocean[my_num].eist[k];
   evenjstart = gp_ocean[my_num].ejst[k];
   oddistart = gp_ocean[my_num].oist[k];
   oddjstart = gp_ocean[my_num].ojst[k];
   eveniendst = gp_ocean[my_num].eiest[k];
   evenjendst = gp_ocean[my_num].ejest[k];
   oddiendst = gp_ocean[my_num].oiest[k];
   oddjendst = gp_ocean[my_num].ojest[k];

   iend = gp_ocean[my_num].rel_start_y[k] + gp_ocean[my_num].rel_num_y[k];
   jend = gp_ocean[my_num].rel_start_x[k] + gp_ocean[my_num].rel_num_x[k];
...

{
   ...
   istart = gp_ocean[my_num].rlist[krc];
   jstart = gp_ocean[my_num].rljst[krc];
   iend = gp_ocean[my_num].rlien[krc];
   jend = gp_ocean[my_num].rljen[krc];
   iend = gp_ocean[my_num].rel_start_y[krc] + gp_ocean[my_num].rel_num_y[krc] - 1;
   jend = gp_ocean[my_num].rel_start_x[krc] + gp_ocean[my_num].rel_num_x[krc] - 1;
...

{
   ...
   istart = gp_ocean[my_num].iist[kc];
   jstart = gp_ocean[my_num].ijst[kc];
   iend = gp_ocean[my_num].iien[kc];
   jend = gp_ocean[my_num].ijen[kc];

   istart = gp_ocean[my_num].rel_start_y[kc];
   jstart = gp_ocean[my_num].rel_start_x[kc];
   iend = gp_ocean[my_num].rel_start_y[kc] + gp_ocean[my_num].rel_num_y[kc] - 1;
   jend = gp_ocean[my_num].rel_start_x[kc] + gp_ocean[my_num].rel_num_x[kc] - 1;
   if17 = 2*(istart-1);  
   for(ic=istart;ic<=iend;ic++) {
...

{
   ...
   istart = gp_ocean[my_num].pist[k];
   jstart = gp_ocean[my_num].pjst[k];
   iend = gp_ocean[my_num].pien[k];
   jend = gp_ocean[my_num].pjen[k];
