...
double	randlc_simple(double *X, double *A)
{
  double		T1, T2, T3, T4;
  double		A1;
  double		A2;
...
void	create_seq_random_simple( double seed, double a , int q, int *arr,
				  THREADED)
{
	double		x;
	register int    i, j, k;
