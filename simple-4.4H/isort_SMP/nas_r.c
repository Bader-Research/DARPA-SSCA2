...
double	randlc_smp(double *X, double *A)
{
  double		T1, T2, T3, T4;
  double		A1;
  double		A2;
...
void	create_seq_smp( double seed, double a , int q, int *arr, THREADED)
{
	double		x;
	register int    i, j, k;
...
void	create_seq_random_smp( double seed, double a , int q, int *arr,
				  THREADED)
{
	double		x;
	register int    i, j, k;
